    ...
    <body>
        <%
            ...
            if (request.getParameter("tag") != null) {
                query = request.getParameter("tag");
            }
            ...
            total = pd.countProductByTag(query);
            if (total <= 9) {
                firstResult = 0;
                maxResult = total;
            } else {
            ...
            ArrayList<products> listProduct = pd.getListProductByTag(query, firstResult, maxResult);
        %>
...
<!--                                                <div class="grid-action-box">
                                                    <form action="CartServlet?command=plus&productID=<%=p.getIDsp()%>&url=<%=a%>?category=<%=p.getIDct()%>" class="product_item_form" method="post">	
                            ...
                            <div class="pages">
                                <ul class="list-unstyled">
                                    ...
                                    <li class="current"><%=i%></li>
                                        <%} else {
                                        %>                                    
                                    <li class="arrow"><a href="search.jsp?query=<%=query%>&pages=<%=i%>"><%=i%></a></li>
                                        <%}
                                        }%>
                                </ul>
                            </div>
