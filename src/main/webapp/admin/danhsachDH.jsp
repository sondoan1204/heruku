    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <jsp:include page="menu.jsp"></jsp:include>
                ...
                <div id="page-wrapper">
                    <a href="../admin/themdonhang.jsp">Thêm đơn hàng</a>
                <div class="row">
                    <div class="col-lg-12">
                        <table class="table table-bordered table-hover">
                            ...
                            <center>
                                <%if (dh.getSt() == true) {%>
                                <a href="../admin/chitiethoadon.jsp?ID_Order=<%=dh.getIdDonhang()%>">Chi tiết</a>
                                <a href="../DonHangServlet?command=deletean&ID_Order=<%=dh.getIdDonhang()%>&URL1204=<%=url%>">Xóa</a>
                                <%} else {%>
                                <a href="../DonHangServlet?command=khoiphuchang&ID_Order=<%=dh.getIdDonhang()%>&URL1204=<%=url%>">Khôi phục</a>
                                <%}%>
                            </center>
                            </td>
                            </tr>
