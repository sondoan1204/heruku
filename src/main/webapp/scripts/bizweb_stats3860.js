{
    ...
    if (!cookieData && !sessionStorageData) {
        ...
        var req = "https://big-food.bizwebvietnam.net/visit/record.gif?p=" + encodeURIComponent(getUrlWithoutDomain(window.location.href)) + "&r=" + encodeURIComponent(document.referrer) + "&s=" + cookieValue;
