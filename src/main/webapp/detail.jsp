...
<html xmlns:fb='http://www.facebook.com/2008/fbml' >
    ...
    <head>
        ...
        <meta property="og:description"   content="Mô tả: <%=product.getMotangan()%>" />
        <meta property="og:image"         content="<%=product.getAnh2()%>" />
                ...
                <div class="product row">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="featured-image">
                            <img src="<%=product.getAnhbia()%>" alt="<%=product.getTen()%>">
                        </div>
                        <div class="images">
                            <div class="imgowl" >
                                <div class="img-item col-xs-12">
                                    <a href="<%=product.getAnh1()%>">
                                        <img src="<%=product.getAnh1()%>" alt="<%=product.getTen()%>">
                                    </a>
                                </div>
                                <div class="img-item col-xs-12">
                                    <a href="<%=product.getAnh2()%>">
                                        <img src="<%=product.getAnh2()%>" alt="<%=product.getTen()%>">
                                    </a>
                                </div>
                            </div> 
                        </div>
                        ...
                        <form action="" method="post">
                            <div class="prod-desc">
                                ...
                                <div class="action-box clearfix">
                                    ...
                                    <a href='Cart2Servlet?command=plus&productID=<%=product.getIDsp()%>&url=<%=a%>?product=<%=product.getIDct()%>' class="btn btn-primary addtocart">Mua hàng</a>
                                </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="tab_2">
                            <div class="std">
                                ...
                                <div class="fb-comments" data-href="https://sondoan1204-javatest.herokuapp.com/detail.jsp?product=<%=product.getIDsp()%>" data-width="100%" data-num-posts="20"></div>
