                    ...
                    fjs.parentNode.insertBefore(js, fjs);
                                        ...
                                        <img src="./images-product/<%=product.getAnh2()%>" alt="<%=product.getTen()%>">
                                            ...
                                            <div onclick="var result = document.getElementById('qty'); var qty = result.value; if (!isNaN(qty) & amp; & amp; qty > 1) result.value--; return false;" class="btn mathbtn" data-dir="dwn"><span class="fa fa-minus"></span></div>
                                                                                ...
                                                                                <input type="text" id="qty" class="bizwebinput form-control product_input_qty qtt-center" value="1" name="quantity" min="1"
                                                                                    onpaste="return false;" onkeypress='validate(event)'
                                                                                />
                                            ...
                                            <div onclick="var result = document.getElementById('qty');
                                                    ...
                                                    <div class="fb-like" data-href="https://sondoan1204-javatest.herokuapp.com/detail.jsp?product=<%=product.getIDsp()%>" data-layout="standard"
                                        ...
                                        if (t == null) {%>
                                                                ...
                                                                <%break;
                                                                    ...
                                                                    <li class="producttagsli">
                                                                        <a href="tag.jsp?tag=<%=t.getTagName()%>" title="<%=t.getTagName()%>">
                                                                            <%=t.getTagName()%>
                                                                        </a>
                                                                    </li>
                                                                    <%}%>
