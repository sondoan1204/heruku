...
<html>
    ...
    <body>
        <%
            ...
            total = pd.countProductByCategory(category_id);
            if (total <= 9) {
                firstResult = 0;
                maxResult = total;
            } else {
            ...
            ArrayList<products> listProduct = pd.getListProductByNav(
                                ...
                                <div class="product-grid clearfix">
                                    ...
                                    <div class="prod-info">
                                        ...
                                        <div class="action-box">
                                                ...
                                                <button type="submit" onclick="window.location.href='CartServlet?command=plus&productID=<%=p.getIDsp()%>&url=<%=q%>'" title="Mua hàng" class="list-add-cart add-to-cart">				
                                                    <span>Mua hàng</span>
                                                </button>		
