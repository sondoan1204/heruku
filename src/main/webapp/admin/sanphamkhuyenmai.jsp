<%-- 
    Document   : sanphamkhuyenmai
    Created on : Dec 7, 2016, 10:52:02 PM
    Author     : SONPC
--%>
    ...
    <%
        ...
        int pages = 0, firstResult = 0, maxResult = 0, total = 0;
            if (request.getParameter("pages") != null) {
             ...
             total = productDAO.countSanPhamKM();
            if (total <= 5) {
                firstResult = 1;
                maxResult = total;
            }else{
        ...
        ArrayList<Product> listProduct = productDAO.getListProductKM(firstResult,maxResult);
    %>
    <div id="wrapper">
        ...
        <jsp:include page="menu.jsp"></jsp:include>
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <i class="fa fa-table"></i> Danh sách sản phẩm Khuyến mãi
                    </li>
                </ol>
            </div>
            <div id="page-wrapper">
