                    ...
                    <div class="account-login">				
                        <form accept-charset='UTF-8' action='UsersServlet' method='post'>
                            ...
                            <div class="col-md-6 new-users">
                                ...
                                <button style="background: #3b5998;" type="button" title="Đăng nhập tài khoản bằng Facebook" class="button" onclick="window.location.href = 'https://www.facebook.com/dialog/oauth?client_id=429789270711609&redirect_uri=https://sondoan1204-javatest.herokuapp.com/Sandwich/OAuth2fb&scope=email&scope=user_friends';"><span><span>Facebook</span></span></button>                                
                                <button style="background: #333;" type="button" title="Đăng nhập tài khoản bằng GitHub" class="button" onclick="window.location.href = 'https://github.com/login/oauth/authorize?client_id=02edf4e25d434e53b086&redirect_uri=http://localhost:8080/Sandwich/Oauth2git&scope=user';"><span><span>GitHub</span></span></button>
                                </div>
                                </div>
