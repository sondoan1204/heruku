                    ...
                    <div class="account-login">				
                        <form accept-charset='UTF-8' action='UsersServlet' method='post'>
                            ...
                            <div class="col-md-6 new-users">
                                ...
                                <button style="background: #3b5998;" type="button" title="Đăng nhập tài khoản bằng Facebook" class="button" onclick="window.location.href = 'https://www.facebook.com/dialog/oauth?client_id=825850937514684&redirect_uri=http://localhost:8080/Sandwich/OAuth2fb&scope=email&scope=user_friends';"><span><span>Facebook</span></span></button>                                
